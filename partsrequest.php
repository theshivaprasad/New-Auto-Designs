                    ...
                    <div class="form-block bg-grey overflow-none bt-radius">
                        ...
                        <form id="qapform" class="form-custompartrequest w-100 float-left bb-radius" method='get' action="final.php" style="background-color: #d8b6f7;">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9"> 
                                    <select name="engine_liter" id="engine_liter"  oninput="myFunction(event)" class="form-control qap_part_class" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <select name="fuel_type" id="fuel_type" oninput="myFunction(event)" class="form-control qap_part_class" required>
                            ...
                            <div class="form-group row">
                                ...
                                -->
                                <input class="form-control" size="25" class="custom-select" id = "message" name="message" placeholder="Message (optional)" type="text">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <select name="body_style" id="body_style" oninput="myFunction(event)" class="form-control " required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <select name="engine_size" id="engine_size" oninput="myFunction(event)" class="form-control " required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <select name="transmission_type" id="transmission_type" oninput="myFunction(event)" class="form-control " required>
